      ...
      <div class="row">
         <div class="leftcolumn">
            <div class="card">
               ...
               <h4>Work Experient :{{$tutor->work_experient}}</h3>
                  <h4>Email: {{$tutor->email}}</h4>
                  <h4>Phone : {{$tutor->phone}}</h4>
                  <h4>Address : {{$tutor->address}}</h4>
            </div>
         </div>
         @endforeach
         ...
         <div class="rightcolumn">
            <div class="card">
               ...
               <h5>
                  <li><a class="pagelink" href="#">{{$course -> Ncourse}}</a></li>
               </h5>
               @endforeach
            </div>
         </div>
